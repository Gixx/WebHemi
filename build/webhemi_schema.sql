...
CREATE TABLE `webhemi_domain` (
    ...
    UNIQUE KEY `unq_domain_name` (`domain`),
    UNIQUE KEY `unq_domain_title` (`title`)
)
    ENGINE = InnoDB
...
LOCK TABLES `webhemi_domain` WRITE;
/*!40000 ALTER TABLE `webhemi_domain`
    DISABLE KEYS */;
INSERT INTO `webhemi_domain` VALUES
(1, 'http://', 'localhost', 'WebHemi', 1, 1, NOW(), NULL);
/*!40000 ALTER TABLE `webhemi_domain`
    ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `webhemi_application` (
    ...
    `fk_domain`      INT(10) UNSIGNED             NOT NULL,
    ...
    UNIQUE KEY `unq_application_url` (`fk_domain`, `path`),
    INDEX `indx_application_fk_domain` (`fk_domain`),
...
INSERT INTO `webhemi_application` VALUES
    (1, 1, '/admin', 'admin', 'Admin', 'default', 'en_GB.UTF-8', 'Europe/London', '', '', '', '', '', 1, 1, NOW(), NULL),
    (2, 1, '/', 'website', 'Website', 'default', 'en_GB.UTF-8', 'Europe/London', '<h1>Welcome to the WebHemi!</h1>', 'Technical stuff', 'The default application for the `www` subdomain.', 'php,html,javascript,css', 'Copyright © 2019. WebHemi', 1, 1, NOW(), NULL);
/*!40000 ALTER TABLE `webhemi_application`
    ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `webhemi_resource` VALUES
    ...
    (1100001, 'admin-content-editor-index', 'Access to Content Editor', '', 'route', 1, NOW(), NULL),

    (1200001, 'admin-control-panel-index', 'List Control Panel items', '', 'route', 1, NOW(), NULL),
        (1200101, 'admin-control-panel-domains-list',   'List Domains', '', 'route', 1, NOW(), NULL),
        (1200102, 'admin-control-panel-domains-view',   'View a Domain', '', 'route', 1, NOW(), NULL),
        (1200103, 'admin-control-panel-domains-add',    'Add a new Domain', '', 'route', 1, NOW(), NULL),
        (1200104, 'admin-control-panel-domains-edit',   'Edit a Domain', '', 'route', 1, NOW(), NULL),
        (1200105, 'admin-control-panel-domains-delete', 'Delete a Domain', '', 'route', 1, NOW(), NULL),

        (1200201, 'admin-control-panel-applications-list',   'List Applications', '', 'route', 1, NOW(), NULL),
        (1200202, 'admin-control-panel-applications-view',   'View an Application', '', 'route', 1, NOW(), NULL),
        (1200203, 'admin-control-panel-applications-add',    'Add a new Application', '', 'route', 1, NOW(), NULL),
        (1200204, 'admin-control-panel-applications-edit',   'Edit an Application', '', 'route', 1, NOW(), NULL),
        (1200205, 'admin-control-panel-applications-delete', 'Delete an Application', '', 'route', 1, NOW(), NULL),

        (1200301, 'admin-control-panel-settings-list',   'List Settings', '', 'route', 1, NOW(), NULL),
        (1200302, 'admin-control-panel-settings-view',   'View a Setting', '', 'route', 1, NOW(), NULL),
        (1200303, 'admin-control-panel-settings-add',    'Add a new Setting', '', 'route', 1, NOW(), NULL),
        (1200304, 'admin-control-panel-settings-edit',   'Edit a Setting', '', 'route', 1, NOW(), NULL),
        (1200305, 'admin-control-panel-settings-delete', 'Delete a Setting', '', 'route', 1, NOW(), NULL),

        (1200401, 'admin-control-panel-themes-list',   'List Themes', '', 'route', 1, NOW(), NULL),
        (1200402, 'admin-control-panel-themes-view',   'View a Theme', '', 'route', 1, NOW(), NULL),
        (1200403, 'admin-control-panel-themes-add',    'Add a new Theme', '', 'route', 1, NOW(), NULL),
        (1200404, 'admin-control-panel-themes-delete', 'Delete a Theme', '', 'route', 1, NOW(), NULL),

        (1200501, 'admin-control-panel-addons-list',   'List AddOns', '', 'route', 1, NOW(), NULL),
        (1200502, 'admin-control-panel-addons-view',   'View a AddOn', '', 'route', 1, NOW(), NULL),
        (1200503, 'admin-control-panel-addons-add',    'Add a new AddOn', '', 'route', 1, NOW(), NULL),
        (1200504, 'admin-control-panel-addons-edit',   'Edit a AddOn', '', 'route', 1, NOW(), NULL),
        (1200505, 'admin-control-panel-addons-delete', 'Delete a AddOn', '', 'route', 1, NOW(), NULL),

        (1200601, 'admin-control-panel-users-list',   'List Users', '', 'route', 1, NOW(), NULL),
        (1200602, 'admin-control-panel-users-view',   'View a User', '', 'route', 1, NOW(), NULL),
        (1200603, 'admin-control-panel-users-add',    'Add a new User', '', 'route', 1, NOW(), NULL),
        (1200604, 'admin-control-panel-users-edit',   'Edit a User', '', 'route', 1, NOW(), NULL),
        (1200605, 'admin-control-panel-users-delete', 'Delete a User', '', 'route', 1, NOW(), NULL),

        (1200701, 'admin-control-panel-groups-list',   'List Groups', '', 'route', 1, NOW(), NULL),
        (1200702, 'admin-control-panel-groups-view',   'View a Group', '', 'route', 1, NOW(), NULL),
        (1200703, 'admin-control-panel-groups-add',    'Add a new Group', '', 'route', 1, NOW(), NULL),
        (1200704, 'admin-control-panel-groups-edit',   'Edit a Group', '', 'route', 1, NOW(), NULL),
        (1200705, 'admin-control-panel-groups-delete', 'Delete a Group', '', 'route', 1, NOW(), NULL),

        (1200801, 'admin-control-panel-resources-list',   'List Resources', '', 'route', 1, NOW(), NULL),
        (1200802, 'admin-control-panel-resources-view',   'View a Resource', '', 'route', 1, NOW(), NULL),
        (1200803, 'admin-control-panel-resources-add',    'Add a new Resource', '', 'route', 1, NOW(), NULL),
        (1200804, 'admin-control-panel-resources-edit',   'Edit a Resource', '', 'route', 1, NOW(), NULL),
        (1200805, 'admin-control-panel-resources-delete', 'Delete a Resource', '', 'route', 1, NOW(), NULL),

        (1200901, 'admin-control-panel-policies-list',   'List Policies', '', 'route', 1, NOW(), NULL),
        (1200902, 'admin-control-panel-policies-view',   'View a Policy', '', 'route', 1, NOW(), NULL),
        (1200903, 'admin-control-panel-policies-add',    'Add a new Policy', '', 'route', 1, NOW(), NULL),
        (1200904, 'admin-control-panel-policies-edit',   'Edit a Policy', '', 'route', 1, NOW(), NULL),
        (1200905, 'admin-control-panel-policies-delete', 'Delete a Policy', '', 'route', 1, NOW(), NULL),

        (1201001, 'admin-control-panel-logs-list',   'List Logs', '', 'route', 1, NOW(), NULL),
        (1201002, 'admin-control-panel-logs-view',   'View a Log', '', 'route', 1, NOW(), NULL),
...
CREATE TABLE `webhemi_policy` (
    ...
    UNIQUE KEY `unq_policy` (`fk_resource`, `fk_application`),
    UNIQUE KEY `unq_policy_title` (`title`),
    INDEX `idx_policy_fk_resource` (`fk_resource`),
    INDEX `idx_policy_fk_application` (`fk_application`),
...
INSERT INTO `webhemi_policy` VALUES
    (777, NULL, NULL, 'supervisor', 'Supervisor access', 'Allow access to all resources in every application.', 1, NOW(), NULL),

    (1000001, 1000001, 1, 'dashboard', 'Dashborad access', 'Allow to view the dashboard.', 1, NOW(), NULL),

    (1100001, 1100001, 1, 'content-editor-index', 'Content Editor access', 'View the Content Editor page.', 1, NOW(), NULL),

    (1200001, 1200001, 1, 'control-panel-index', 'Control Panel access', 'View the Control Panel page.', 1, NOW(), NULL),
        (1200101, 1200101, 1, 'control-panel-domains-list',        'List Domains',          '', 1, NOW(), NULL),
        (1200102, 1200102, 1, 'control-panel-domains-view',        'View a Domain',         '', 1, NOW(), NULL),
        (1200103, 1200103, 1, 'control-panel-domains-add',         'Add a new Domain',      '', 1, NOW(), NULL),
        (1200104, 1200104, 1, 'control-panel-domains-edit',        'Edit a Domain',         '', 1, NOW(), NULL),
        (1200105, 1200105, 1, 'control-panel-domains-delete',      'Delete a Domain',       '', 1, NOW(), NULL),

        (1200201, 1200201, 1, 'control-panel-applications-list',   'List Applications',     '', 1, NOW(), NULL),
        (1200202, 1200202, 1, 'control-panel-applications-view',   'View an Application',   '', 1, NOW(), NULL),
        (1200203, 1200203, 1, 'control-panel-applications-add',    'Add a new Application', '', 1, NOW(), NULL),
        (1200204, 1200204, 1, 'control-panel-applications-edit',   'Edit an Application',   '', 1, NOW(), NULL),
        (1200205, 1200205, 1, 'control-panel-applications-delete', 'Delete an Application', '', 1, NOW(), NULL),

        (1200301, 1200301, 1, 'control-panel-settings-list',       'List Settings',         '', 1, NOW(), NULL),
        (1200302, 1200302, 1, 'control-panel-settings-view',       'View a Setting',        '', 1, NOW(), NULL),
        (1200303, 1200303, 1, 'control-panel-settings-add',        'Add a new Setting',     '', 1, NOW(), NULL),
        (1200304, 1200304, 1, 'control-panel-settings-edit',       'Edit a Setting',        '', 1, NOW(), NULL),
        (1200305, 1200305, 1, 'control-panel-settings-delete',     'Delete a Setting',      '', 1, NOW(), NULL),

        (1200401, 1200401, 1, 'control-panel-themes-list',         'List Themes',           '', 1, NOW(), NULL),
        (1200402, 1200402, 1, 'control-panel-themes-view',         'View a Theme',          '', 1, NOW(), NULL),
        (1200403, 1200403, 1, 'control-panel-themes-add',          'Add a Theme',           '', 1, NOW(), NULL),
        (1200404, 1200404, 1, 'control-panel-themes-delete',       'Delete a Theme',        '', 1, NOW(), NULL),

        (1200501, 1200501, 1, 'control-panel-addons-list',         'List AddOns',           '', 1, NOW(), NULL),
        (1200502, 1200502, 1, 'control-panel-addons-view',         'View a AddOn',          '', 1, NOW(), NULL),
        (1200503, 1200503, 1, 'control-panel-addons-add',          'Add a new AddOn',       '', 1, NOW(), NULL),
        (1200504, 1200504, 1, 'control-panel-addons-edit',         'Edit a AddOn',          '', 1, NOW(), NULL),
        (1200505, 1200505, 1, 'control-panel-addons-delete',       'Delete a AddOn',        '', 1, NOW(), NULL),

        (1200601, 1200601, 1, 'control-panel-users-list',          'List Users',            '', 1, NOW(), NULL),
        (1200602, 1200602, 1, 'control-panel-users-view',          'View a User',           '', 1, NOW(), NULL),
        (1200603, 1200603, 1, 'control-panel-users-add',           'Add a new User',        '', 1, NOW(), NULL),
        (1200604, 1200604, 1, 'control-panel-users-edit',          'Edit a User',           '', 1, NOW(), NULL),
        (1200605, 1200605, 1, 'control-panel-users-delete',        'Delete a User',         '', 1, NOW(), NULL),

        (1200701, 1200701, 1, 'control-panel-groups-list',         'List Groups',           '', 1, NOW(), NULL),
        (1200702, 1200702, 1, 'control-panel-groups-view',         'View a Group',          '', 1, NOW(), NULL),
        (1200703, 1200703, 1, 'control-panel-groups-add',          'Add a new Group',       '', 1, NOW(), NULL),
        (1200704, 1200704, 1, 'control-panel-groups-edit',         'Edit a Group',          '', 1, NOW(), NULL),
        (1200705, 1200705, 1, 'control-panel-groups-delete',       'Delete a Group',        '', 1, NOW(), NULL),

        (1200801, 1200801, 1, 'control-panel-resources-list',      'List Resources',        '', 1, NOW(), NULL),
        (1200802, 1200802, 1, 'control-panel-resources-view',      'View a Resource',       '', 1, NOW(), NULL),
        (1200803, 1200803, 1, 'control-panel-resources-add',       'Add a new Resource',    '', 1, NOW(), NULL),
        (1200804, 1200804, 1, 'control-panel-resources-edit',      'Edit a Resource',       '', 1, NOW(), NULL),
        (1200805, 1200805, 1, 'control-panel-resources-delete',    'Delete a Resource',     '', 1, NOW(), NULL),

        (1200901, 1200901, 1, 'control-panel-policies-list',       'List Policies',         '', 1, NOW(), NULL),
        (1200902, 1200902, 1, 'control-panel-policies-view',       'View a Policy',         '', 1, NOW(), NULL),
        (1200903, 1200903, 1, 'control-panel-policies-add',        'Add a new Policy',      '', 1, NOW(), NULL),
        (1200904, 1200904, 1, 'control-panel-policies-edit',       'Edit a Policy',         '', 1, NOW(), NULL),
        (1200905, 1200905, 1, 'control-panel-policies-delete',     'Delete a Policy',       '', 1, NOW(), NULL),

        (1201001, 1201001, 1, 'control-panel-logs-list',           'List Logs',             '', 1, NOW(), NULL),
        (1201002, 1201002, 1, 'control-panel-logs-view',           'View a Log',            '', 1, NOW(), NULL),

    (1300001, 1300001, 1, 'about-index', 'View the About page', '', 1, NOW(), NULL);
/*!40000 ALTER TABLE `webhemi_policy`
    ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `webhemi_user` (
    ...
    INDEX `idx_user_is_enabled` (`is_enabled`)
)
    ENGINE = InnoDB
    DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `webhemi_user_to_policy` (
    ...
    INDEX `idx_user_to_policy_fk_user` (`fk_user`),
    INDEX `idx_user_to_policy_fk_policy` (`fk_policy`),
...
CREATE TABLE `webhemi_user_to_user_group` (
    ...
    INDEX `idx_user_to_user_group_fk_user` (`fk_user`),
    INDEX `idx_user_to_user_group_fk_user_group` (`fk_user_group`),
...
CREATE TABLE `webhemi_user_group_to_policy` (
    ...
    INDEX `idx_user_group_to_policy_fk_user_group` (`fk_user_group`),
    INDEX `idx_user_group_to_policy_fk_policy` (`fk_policy`),
...
CREATE TABLE `webhemi_filesystem_document` (
    ...
    INDEX `idx_filesystem_document_content_revision` (`content_revision`),
    INDEX `idx_filesystem_document_fk_parent_revision` (`fk_parent_revision`),
    INDEX `id_filesystem_document_fk_author` (`fk_author`),
...
CREATE TABLE `webhemi_filesystem_category` (
    ...
    INDEX `idx_filesystem_category_fk_application` (`fk_application`),
...
CREATE TABLE `webhemi_filesystem_tag` (
    ...
    UNIQUE KEY `unq_filesystem_file_file_hash` (`fk_application`, `name`),
    INDEX `idx_filesystem_tag_fk_application` (`fk_application`),
...
CREATE TABLE `webhemi_filesystem` (
    ...
    INDEX `idx_filesystem_fk_application` (`fk_application`),
    INDEX `idx_filesystem_fk_category` (`fk_category`),
    INDEX `idx_filesystem_fk_parent_node` (`fk_parent_node`),
    INDEX `idx_filesystem_fk_filesystem_document` (`fk_filesystem_document`),
    INDEX `idx_filesystem_fk_filesystem_file` (`fk_filesystem_file`),
    INDEX `idx_filesystem_fk_filesystem_directory` (`fk_filesystem_directory`),
    INDEX `idx_filesystem_fk_filesystem_link` (`fk_filesystem_link`),
    INDEX `idx_filesystem_path` (`path`),
    INDEX `idx_filesystem_file_basename` (`basename`),
    INDEX `idx_filesystem_is_hidden` (`is_hidden`),
    INDEX `idx_filesystem_is_read_only` (`is_read_only`),
    INDEX `idx_filesystem_is_deleted` (`is_deleted`),
    INDEX `idx_filesystem_date_published_archive` (`date_published_archive`),
...
CREATE TABLE `webhemi_filesystem_to_filesystem_tag` (
    ...
    INDEX `idx_filesystem_to_filesystem_tag_filesystem_tag` (`fk_filesystem_tag`),
    INDEX `idx_filesystem_to_filesystem_tag_filesystem` (`fk_filesystem`),
...
CREATE TABLE `webhemi_filesystem_document_attachment` (
    ...
    INDEX `idx_filesystem_document_attachment_filesystem_document` (`fk_filesystem_document`),
    INDEX `idx_filesystem_document_attachment_filesystem` (`fk_filesystem`),
