...
INSERT INTO `webhemi_am_policy` VALUES (90000, NULL, NULL, 'all', 'All - All - Any', 'Access to all resources in every application with any method', NULL, 1, 1, '2016-10-10 10:10:10', NULL), (90001, 90000, NULL, 'some', 'Some - All - Get', 'Access to `Some Resource` in every application', 'GET', 1, 1, '2016-10-10 10:10:10', NULL), (90002, NULL, 90000, 'all-unit', 'All - Unit - Post', 'Access to all resources in `Unit Test` application', 'POST', 1, 1, '2016-10-10 10:10:10', NULL), (90003, 90000, 90000, 'some-unit', 'Some - Unit - Any', 'Access to `Some Resource` in `Unit Test` application', NULL, 1, 1, '2016-10-10 10:10:10', NULL);
