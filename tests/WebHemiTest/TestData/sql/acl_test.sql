INSERT INTO `webhemi_application` VALUES (90000, 'unit_test', 'Unit Test', 'Unit Test Application.', 0, 1, '2016-10-10 10:10:10', NULL);
INSERT INTO `webhemi_am_resource` VALUES (90000, '\WebHemiTestX\Some\Resource', 'Some resource', '', 0, '2016-10-10 10:10:10', NULL);
INSERT INTO `webhemi_am_policy` VALUES (90000, NULL, NULL, 'all', 'All - All', 'Access to all resources in every application', 1, 1, '2016-10-10 10:10:10', NULL), (90001, 90000, NULL, 'some', 'Some - All', 'Access to `Some Resource` in every application', 1, 1, '2016-10-10 10:10:10', NULL), (90002, NULL, 90000, 'all-unit', 'All - Unit', 'Access to all resources in `Unit Test` application', 1, 1, '2016-10-10 10:10:10', NULL), (90003, 90000, 90000, 'some-unit', 'Some - Unit', 'Access to `Some Resource` in `Unit Test` application', 1, 1, '2016-10-10 10:10:10', NULL);
